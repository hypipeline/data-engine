...
def _sync_buyers(pg, buyers, log):
    ...
    for bid, b in buyers.items():
        ...
        rows.append((
            ...
            b.get("specific_matching_criteria"),
    ...
    sql = """INSERT INTO buyer_match.buyers
        (id,name,description,investment_thesis,sector_keywords,website,tags,
         email_count,linkedin_count,no_of_employees,email_domains,is_specialist,specific_matching_criteria,embedding,embed_model,embed_version,embedding_text_hash,embedded_at)
        VALUES %s ON CONFLICT (id) DO UPDATE SET
         ...
         specific_matching_criteria=EXCLUDED.specific_matching_criteria,
    ...
    with pg.cursor() as cur:
        psycopg2.extras.execute_values(cur, sql, rows,
            template="(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s::vector,%s,%s,%s,%s)", page_size=500)
