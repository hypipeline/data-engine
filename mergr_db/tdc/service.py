"""
TDC — read queries over the subscriber replica.

Everything here reads Postgres only; the DynamoDB pull lives in tdc.sync.
"""
import os
...
def signups_by_day(conn, days=30):
    ...
    return _rows(conn, """
        ...
        LEFT JOIN tdc.subscribers s ON s.created_at::date = g.day::date
