...
DEALS = [
    ...
    {"key": "scan", "label": "Scan", "href": "/tdc/deals/scan",
     "built": True,
     "blurb": "Raw harvest from the watched sources, before triage."},
    {"key": "dossiers", "label": "Dossiers", "href": "/tdc/deals/dossiers",
     "built": True,
     "blurb": "Accounts of the same transaction, grouped."},
