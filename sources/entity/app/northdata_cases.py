...
CASES = [
    ...
    {"slug": "red_enterprises", "name": "RED Enterprises Ltd. (Glasgow)",
     "url": "https://www.northdata.com/red+enterprises+limited",
     "fixture": "red_enterprises.svg.html",
     "expect": {"root": "RED Enterprises Ltd.", "ultimate_parent": "Anderson Pomeroy"},
     "note": "Held ≥75% by Anderson Pomeroy Ltd. — parent must be surfaced."},
